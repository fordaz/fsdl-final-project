...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max_annotations", type=int, help="Maximum number of annotations", default=30
    )
    parser.add_argument(
        "--max_annotation_length",
        type=int,
        help="Maximum number of annotations",
        default=100,
    )
    parser.add_argument(
        "--temperature", type=float, help="Maximum number of annotations", default=1.0
    )
