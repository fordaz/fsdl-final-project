...
def generate_clean_annotations(input_train_dir, input_test_dir, train_split, full_output_fname):
    ...
    train_val_dataset = process_raw_annotations(
        training_files, lambda idx: "train" if idx <= num_training_files else "val"
    )
    ...
    test_dataset = process_raw_annotations(testing_files, lambda idx: "test")
